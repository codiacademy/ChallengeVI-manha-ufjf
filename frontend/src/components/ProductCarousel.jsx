    ...
    <div className="p-8  text-gray-900">
      ...
      <Slider {...settings}>
        {products.map((product) => (
          <div key={product.id} className="flex flex-col items-center p-6 bg-violet-400 text-black rounded-lg shadow-md">
            <img
            ...
            <div className="text-xl font-bold text-violet-700 mb-6">R$ {product.price.toFixed(2)}</div>
            <Link
              to="/compras"
              state={{ product }}
            >
